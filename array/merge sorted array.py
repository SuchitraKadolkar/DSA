...
that should be merged, and the last n elements are set to 0 and should be ignored. nums2 has a length 
of n.
...
nums1 = [int(x) for x in input("Enter 1st array elements: ").split()]
nums2 = [int(x) for x in input("Enter 2nd array elements: ").split()]
